...
import kotlinx.android.synthetic.main.uploaded_documents_fragment.*
import org.json.JSONObject
import org.kodein.di.KodeinAware
import org.kodein.di.android.x.kodein
import org.kodein.di.generic.instance

class UploadedDocuments : Fragment(), KodeinAware,DocListener {
    private var prefs: PreferenceProvider? = null
    override val kodein by kodein()
    private val factory:UploadViewModelFactory by instance()
    private lateinit var viewModel: UploadedDocumentsViewModel
    private lateinit var viewHolder: DocAdapter.MoviesViewHolder
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        return inflater.inflate(R.layout.uploaded_documents_fragment, container, false)
    }

    override fun onActivityCreated(savedInstanceState: Bundle?) {
        super.onActivityCreated(savedInstanceState)
        prefs = PreferenceProvider(context!!.applicationContext)
        viewModel = ViewModelProvider(this,factory).get(UploadedDocumentsViewModel::class.java)
        ...
        rv_list.also {
            ...
            val swipeToDeleteCallback = object : SwipeToDeleteCallback() {
                override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                    ...
                    (it.adapter as DocAdapter).notifyItemRemoved(pos)
                }
            }
